...
--
-- Servidor: localhost
-- Tiempo de generación: 07-07-2024 a las 22:36:15
...
INSERT INTO `usuario` (`ID_Usuario`, `Nombre`, `Usuario`, `Contrasena`) VALUES
(5, 'ssss', 'sss', 'f2aca93b80cae681221f0445fa4e2cae8a1f9f8fa1e1741d9639caad222f537d');
...
--
ALTER TABLE `usuario`
  MODIFY `ID_Usuario` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK', AUTO_INCREMENT=6;
...
('root', '[{\"db\":\"juegoderol\",\"table\":\"usuario\"},{\"db\":\"juegoderol\",\"table\":\"equipamiento\"},{\"db\":\"juegoderol\",\"table\":\"personaje_equipamiento\"},{\"db\":\"juegoderol\",\"table\":\"personaje\"},{\"db\":\"juegoderol\",\"table\":\"habilidad\"},{\"db\":\"juegoderol\",\"table\":\"poder\"},{\"db\":\"juegoderol\",\"table\":\"raza\"},{\"db\":\"juegoderol\",\"table\":\"estado\"}]');
...
('root', '2024-07-07 20:35:56', '{\"lang\":\"es\",\"Console\\/Mode\":\"collapse\"}');
